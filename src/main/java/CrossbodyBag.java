...
public class CrossbodyBag extends Bag {
    ...
    public CrossbodyBag(String crossColour, int crossCapacity, int crossNumStraps) {
        super(crossColour, crossCapacity);
        this.numStraps = crossNumStraps;
    }
    ...
    public String toString() {
        return this.getColour() + " Crossbody Bag with " +
